        ...
        <>
            <div className="flex flex-col h-screen items-center justify-center gap-4">
                ...
                <div className="flex gap-2">
                    {capturing ? (
                        <button className ="bg-gray-200 text-black rounded cursor-pointer p-2" onClick={handleStopCaptureClick}>
                            Stop Capture
                        </button>
                    ) : (
                        <button className = "bg-gray-200 text-black rounded cursor-pointer p-2"onClick={handleStartCaptureClick}>
                            Start Capture
                        </button>
                    )}
